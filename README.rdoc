Ruby Implimentation of Granny's Addressbook using MongoDB as the database.


from (https://github.com/mukulpanchal/mongo_rails_demo):
...
8) Your application is ready to run ENJOY!!!
